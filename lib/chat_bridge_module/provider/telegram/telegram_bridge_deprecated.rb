...
#             return(
#               Rails.logger.warn(
#                 "[Telegram Bridge] Received a telegram message but no channel id found. details: \n#{YAML.dump(message)}",
#               )
#             )
#           end
#           if message["from"].nil?
#             return(
#               Rails.logger.warn(
#                 "[Telegram Bridge] Received a telegram message but no message.from found. details: \n#{YAML.dump(message)}",
#               )
#             )
#           end
...
#             return(
#               Rails.logger.warn(
#                 "[Telegram Bridge] Received a telegram message but no message.from.id found. details: \n#{YAML.dump(message)}",
#               )
#             )
#           end
